...
public class AesEncryptUtil {
    ...
    private static String getPasswordKey() {
        return Objects.requireNonNull(xApplication.Companion.getInstance()).getAesPassword();
    }

    private static String getHEX() {
        return Objects.requireNonNull(xApplication.Companion.getInstance()).getAesHex();
    }
